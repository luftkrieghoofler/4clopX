...
import {
    newlyCriticalResources, overviewResourceRows, publishResourceStats,
...
test('uses the highest resource-buffer severity in the tab title', () => {
...
test('publishes a compact Overview resource snapshot for other tabs', () => {
    ...
    try {
        ...
        assert.equal('satisfaction' in published, false);
